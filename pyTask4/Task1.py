...
task()
'''В 3 задании используется .lower(), как и в примере, хотя библиотеки даны с явным учётом регистра ¯\_(ツ)_/¯'''
'''В 5 задании можно использовать библиотеку math, хотя в прошлой работе мне снизили баллы за её использование 🤨🤨🤨'''